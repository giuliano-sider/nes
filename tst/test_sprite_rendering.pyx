...
from ppu cimport Ppu, PPUCTRL, NUM_BYTES_PER_PALETTE, BYTES_PER_SPRITE, SPRITE_Y_OFFSET, SPRITE_X_OFFSET, SPRITE_ATTRIBUTE_OFFSET, SPRITE_TILE_INDEX_OFFSET, NUM_SPRITES_IN_OAM, SPRITE_PALETTE_BASE_ADDR
...
class TestSpriteRendering(unittest.TestCase):
    ...
    def test_render_sprites_single_sprite(self):
        ...
        screen = ppu.render_sprites(np.zeros((SCREEN_HEIGHT, SCREEN_WIDTH), dtype=np.int32))
