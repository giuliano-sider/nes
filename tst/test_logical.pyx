...
class TestLogicalInstructions(unittest.TestCase):
    ...
    def test_if_BIT_sets_status_flags(self):
        ...
        cpu.set_A(0)
        cpu.set_P(0)
        cpu.set_memory(0x01, 0b11000000)
    ...
    def test_if_BIT_absolute_sets_status_flags(self):
        ...
        cpu.set_A(0)
        cpu.set_P(0)
        cpu.set_memory(0x0101, 0b11000000)
    ...
    def test_AND_zeropage(self):
        cdef Cpu cpu = CreateTestCpu()
        cpu.set_A(           0b00010001)
        cpu.set_memory(0x11, 0b00010000)
        cpu.set_P(0xFF)
    ...
    def test_AND_zeropage_x(self):
        ...
        cpu.set_A(           0b00010001)
        cpu.set_X(0x20)
        cpu.set_memory(0x31, 0b00010000)
        cpu.set_P(0xFF)
    ...
    def test_AND_absolute(self):
        cdef Cpu cpu = CreateTestCpu()
        cpu.set_A(           0b00010001)
        cpu.set_memory(0x0111, 0b00010000)
        cpu.set_P(0xFF)
    ...
    def test_AND_absolute_x(self):
        ...
        cpu.set_A(           0b00010001)
        cpu.set_X(0x10)
        cpu.set_memory(0x0121, 0b00010000)
        cpu.set_P(0xFF)
    ...
    def test_AND_indirect_x(self):
        ...
        cpu.set_A(           0b00010001)
        cpu.set_X(0x20)
        cpu.set_memory(0x30, 0x34)
        cpu.set_memory(0x31, 0x12)
        cpu.set_memory(0x1234, 0b00010000)
        cpu.set_P(0xFF)
    ...
    def test_AND_indirect_y(self):
        ...
        cpu.set_A(                  0b00010001)
        cpu.set_Y(0x20)
        cpu.set_memory(0x10, 0x34)
        cpu.set_memory(0x11, 0x12)
        cpu.set_memory(0x1234 + 0x20, 0b00010000)
        cpu.set_P(0xFF)
    ...
    def test_ORA_absolute(self):
        cdef Cpu cpu = CreateTestCpu()
        cpu.set_A(           0b00010001)
        cpu.set_memory(0x1011, 0b00010000)
        cpu.set_P(0xFF)
    ...
    def test_ORA_zeropage(self):
        cdef Cpu cpu = CreateTestCpu()
        cpu.set_A(           0b00010001)
        cpu.set_memory(0x11,   0b00110000)
        cpu.set_P(0xFF)
    ...
    def test_ORA_zeropage_x(self):
        ...
        cpu.set_A(           0b00010001)
        cpu.set_X(0x20)
        cpu.set_memory(0x31,   0b00110000)
        cpu.set_P(0xFF)
    ...
    def test_ORA_absolute_x(self):
        ...
        cpu.set_A(           0b00010001)
        cpu.set_X(0x10)
        cpu.set_memory(0x1021, 0b00010000)
        cpu.set_P(0xFF)
    ...
    def test_EOR_absolute_x(self):
        ...
        cpu.set_A(           0b00010001)
        cpu.set_X(0x10)
        cpu.set_memory(0x1021, 0b00110000)
        cpu.set_P(0xFF)
    ...
    def test_EOR_indirect_x(self):
        ...
        cpu.set_memory(0x30, 0x34)
        cpu.set_memory(0x31, 0x12)
        cpu.set_memory(0x1234, 0b00110000)
        cpu.set_P(0xFF)
    ...
    def test_EOR_indirect_y(self):
        ...
        cpu.set_memory(0x10, 0x34)
        cpu.set_memory(0x11, 0x12)
        cpu.set_memory(0x1234 + 0x20, 0b00110000)
        cpu.set_P(0xFF)
    ...
    def test_ASL_absolute(self):
        cdef Cpu cpu = CreateTestCpu()
        cpu.set_memory(0x1F1E, 0b11010101)
        cpu.set_P(0xFF)
